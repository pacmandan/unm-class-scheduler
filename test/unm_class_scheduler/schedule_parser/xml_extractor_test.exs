    ...
    test "properly extracts from 1 XML file" do
      expected_results = %{
        ...
        Section => [
          ...
          %E{fields: %{credits: "3", credits_max: 3, credits_min: 3, crn: "50004", enrollment: "0", enrollment_max: "0", fees: 0.0, num_meetings: 2, number: "002", waitlist: "0", waitlist_max: "0"}, associations: %{Campus => %{code: "GA"}, Course => %{number: "213"}, DeliveryType => %{code: "LC"}, InstructionalMethod => %{code: "ENH"}, PartOfTerm => %{code: "1"}, Semester => %{code: "2023XX"}, Status => %{code: "A"}, Subject => %{code: "SUBJ2"}}},
        ],
        Instructor => [
        ...
        MeetingTime => [
          ...
          %E{fields: %{end_date: ~D[2023-05-13], end_time: ~T[10:30:00], friday: true, index: 1, monday: true, room: "400", saturday: false, start_date: ~D[2023-01-16], start_time: ~T[08:00:00], sunday: false, thursday: false, tuesday: false, wednesday: false}, associations: %{Building => %{code: "BLDG4"}, Campus => %{code: "GA"}, Section => %{crn: "50004"}, Semester => %{code: "2023XX"}}},
          %E{fields: %{end_date: ~D[2023-05-13], end_time: ~T[14:30:00], friday: false, index: 0, monday: false, room: "400", saturday: true, start_date: ~D[2023-01-16], start_time: ~T[13:00:00], sunday: true, thursday: false, tuesday: false, wednesday: false}, associations: %{Building => %{code: "BLDG4"}, Campus => %{code: "GA"}, Section => %{crn: "50004"}, Semester => %{code: "2023XX"}}},
        ],
        InstructorSection => [
          ...
          %E{fields: %{primary: false}, associations: %{Instructor => %{email: "tmctesterson@unm.edu", first: "Testy", last: "McTesterson"}, Section => %{crn: "50004"}, Semester => %{code: "2023XX"}}},
        ],
        Crosslist => [
