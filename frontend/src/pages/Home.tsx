...
function HomePage() {
  return (<>
    <div className="bg-red-800 w-full h-96 relative mb-4">
      <img src={placeholderUrl} alt="Cover" width="100%" height="24rem" className="w-full h-96 object-cover" />
    ...
    <div className='w-full h-96 relative mb-4 p-10 flex items-center justify-center'>
      <div className='w-[750px] flex items-center justify-center'>
        <img src={placeholderUrl} alt="feature1" className="w-72 h-72 object-cover" />
    ...
    <div className='w-full h-96 relative mb-4 p-10 flex items-center justify-center'>
      <div className='w-[750px] flex items-center justify-center'>
        ...
        <div className='w-10'></div>
        <img src={placeholderUrl} alt="feature2" className="w-72 h-72 object-cover" />
      </div>
    </div>
    <div className='w-full h-96 relative mb-4 p-10 flex items-center justify-center'>
      <div className='w-[750px] flex items-center justify-center'>
        <img src={placeholderUrl} alt="feature3" className="w-72 h-72 object-cover" />
        <div className='w-10'></div>
        <div className='m-5'>
